...
⚠️ **El activo del usuario se nombra "sistema de distribución", siempre y en todas partes** (Director, 6 sep 2026 — reemplaza a *canal de distribución*, doctrina jul 2026, que a su vez había reemplazado al bautizo diferido retirado el 25 ago). **Sinónimo vivo: *empresa de distribución*, y NO se corrige** (Director, 7 sep 2026). El sustituto de *red* es el mismo.
...
>
> ✅ **Estado (7 sep 2026):** los cuatro arsenales migrados, `src/` alineado y **la web migrada** (Home, `/prueba`, `fundadores`, `planes`, `paquetes`, `nosotros`, `lexico`, blog, OG de Queswa y de Nosotros, textos dictados del motor). ⏳ Quedan a propósito, porque no son un reemplazo de palabra sino una reescritura: los decks `/servilleta` y `/12-niveles` (slide *«Cree su negocio digital»*, con su tarjeta OG) — `/servilleta` conserva léxico viejo por SEO (decisión del Director, 27 jun 2026), pero `/12-niveles` es el deck que Queswa enlaza tras NIVELES_01 y hoy le dice *negocio digital* a quien acaba de oír *sistema de distribución*.
>
