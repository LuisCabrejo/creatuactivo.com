...
**Handoff & Context**:
- ⭐ [docs/handoff/queswa/AUDITORIA_TRAFICO_ORGANICO_SEP2026.md](docs/handoff/queswa/AUDITORIA_TRAFICO_ORGANICO_SEP2026.md) — **el más reciente (5 sep): la dinámica cuando entra tráfico real.** Cómo volcar y separar personas de arneses, leer el `search_method` de cada «sí», llevar el fallo hasta el nodo, escribir el arnés que lo reproduce antes de arreglar; el caso Betsabe resuelto y ocho pendientes con diagnóstico hecho
