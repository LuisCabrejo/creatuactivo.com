...
| Plantilla del enlace de canal para socios de EE. UU. | `node scripts/someter-plantilla-acceso-canal.mjs --estado` — `acceso_canal`, sometida UTILITY el 22 ago (sin URL, botón «Ver mi enlace»). A números +1 Meta **no entrega MARKETING**; `ACTIVAR` la usa solo para ese destino. Si sale MARKETING, **no someter otra** |
