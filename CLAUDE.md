...
- **Páginas** (construidas May 2026): [src/app/[slug]/[destino]/page.tsx](src/app/[slug]/[destino]/page.tsx) bifurca render-reel vs redirect; [src/components/ReelPage.tsx](src/components/ReelPage.tsx) (Server Component, estética Bimetálica, video `preload="none"`, 2 CTA); [src/components/ServilletaCTA.tsx](src/components/ServilletaCTA.tsx) ('use client', modal con embed youtube-nocookie). `generateMetadata` emite OG de video + poster (`robots: noindex`).
