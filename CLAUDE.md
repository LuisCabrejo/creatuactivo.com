...
⚠️ **El activo del usuario se nombra "sistema de distribución", siempre y en todas partes** (Director, 6 sep 2026 — reemplaza a *canal de distribución*, doctrina jul 2026, que a su vez había reemplazado al bautizo diferido retirado el 25 ago). Sinónimo válido: *empresa de distribución*. El sustituto de *red* es el mismo.
