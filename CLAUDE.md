...
| Update creatuactivo.com prompt | `node scripts/actualizar-system-prompt-v26.9.mjs` |
...
4. **System Prompt** - Stored in Supabase `system_prompts` table (name: `nexus_main`)
   ...
   - **Bifurcación de embudos**: `nexus_main` v26.9 sirve tráfico orgánico (95%). El 5% de ads tendrá prompt `nexus_ads_premium` cuando se construya la landing `/executive` o `/private`. No crear aún — pendiente.
   ...
   - **Archivo fuente v26.9**: `knowledge_base/system-prompt-nexus-main-v26_9.md` — deploy: `node scripts/actualizar-system-prompt-v26.9.mjs`
...
|---------|-------------|------------------------|
| `creatuactivo.com` | `nexus_main` | `actualizar-system-prompt-v26.9.mjs` (latest: **v26.9 recursos_legibilidad_cognitiva** — apunta a `system-prompt-nexus-main-v26_9.md`) |
...
- `actualizar-system-prompt-v*.mjs` - Versioned update scripts (latest: **v26.9** — recursos_legibilidad_cognitiva, 19 May 2026)
