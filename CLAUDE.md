...
| Update creatuactivo.com prompt | `node scripts/actualizar-system-prompt-v27.2.mjs` (despliega **v28.8 "calidez_sin_diagnostico"** + promesa "madura" — el archivo conserva el nombre legacy `v27.2`) |
...
|---------|-------------|------------------------|
| `creatuactivo.com` | `nexus_main` | `actualizar-system-prompt-v27.2.mjs` (despliega **v28.8 "calidez_sin_diagnostico"** + promesa "madura" — apunta a `system-prompt-nexus-main-v27_2.md`; tanto el script como el archivo conservan el nombre legacy `v27.2`/`v27_2`. Verificar siempre con `leer-system-prompt.mjs`) |
...
- `actualizar-system-prompt-v27.2.mjs` - Deploy del system prompt actual (**v28.8 "calidez_sin_diagnostico"** + promesa "madura") a Supabase. El script y el archivo fuente conservan el nombre legacy `v27.2`/`v27_2`; el contenido interno es v28.8. Las versiones anteriores viven en git
