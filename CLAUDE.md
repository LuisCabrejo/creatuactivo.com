...
| Batería de regresión del clasificador | `node scripts/benchmark-clasificador.mjs --tenant whatsapp` (42/42 al 14 ago; exit 1 si falla) |
...
- **cadencia de pago mezclada** → el consumo es **mensual**, Gano liquida **cada viernes** — y es **un viernes de por medio**: lo comprado en una semana se paga el viernes de la **semana siguiente**, no el viernes inmediato (corrección del Director, 17 ago 2026). Decir *"el viernes siguiente a la compra"* insinúa un pago más rápido del real y decepciona en la primera semana, que es el peor momento. ⏳ Pendiente auditar si algún fragmento lo insinúa. Decir *"le entra mes a mes"* obliga a desenredarlo después ([[reference_gano_paga_semanal]])
