...
>
> **Dónde SÍ sobrevive:** en los **disparadores**, porque son las palabras que el prospecto escribe. `EMPRESA_DIGITAL_01` sigue existiendo para aterrizar a quien oyó el término en otra parte, y **traduce al canónico en su primera línea**. Eso es todo. ✅ **Barrido completo en los cuatro arsenales** (verificado 10 sep 2026): la única ocurrencia que queda en `arsenal_avanzado` y en `arsenal_compensacion` está en la línea de cabecera que explica por qué no se narran las versiones viejas — texto para quien edita, que el fragmentador no sirve. **Cero en cuerpos.** Esta sección decía que faltaban 8 y 11; era un dato viejo.
