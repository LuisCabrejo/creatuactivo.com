...
| Update creatuactivo.com prompt | `node scripts/actualizar-system-prompt-v27.0.mjs` |
...
4. **System Prompt** - Stored in Supabase `system_prompts` table (name: `nexus_main`)
   ...
   - **Bifurcación de embudos**: `nexus_main` v27.0 sirve tráfico orgánico (95%). El 5% de ads tendrá prompt `nexus_ads_premium` cuando se construya la landing `/executive` o `/private`. No crear aún — pendiente.
   ...
   - **Archivo fuente v27.0**: `knowledge_base/system-prompt-nexus-main-v27_0.md` — deploy: `node scripts/actualizar-system-prompt-v27.0.mjs`
...
|---------|-------------|------------------------|
| `creatuactivo.com` | `nexus_main` | `actualizar-system-prompt-v27.0.mjs` (latest: **v27.0 recursos_imperativos_bloqueo_kyc** — apunta a `system-prompt-nexus-main-v27_0.md`) |
...
- `actualizar-system-prompt-v*.mjs` - Versioned update scripts (latest: **v27.0** — recursos_imperativos_bloqueo_kyc, 22 May 2026)
