...
- `prueba-experiencia-socio.mts` (`npx tsx`) — la experiencia del DISTRIBUIDOR (10 sep 2026, caso Patricia Reyes): el canal lo reconoce por su teléfono con o sin indicativo, el saludo con su enlace sale aunque ya tenga ficha de prospecto y **una sola vez**, la ficha queda configurada como distribuidora y sin temperatura, y las piezas publicitarias —incluida la repregunta sin verbo tras la negativa— no llegan al modelo
