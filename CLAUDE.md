...
**Reel HOME (pendiente de producción):** cuando Luis grabe el explainer, reemplaza el `YouTubeFacade` del hero en [src/app/page.tsx](src/app/page.tsx) (hoy apunta a `SERVILLETA_YOUTUBE_ID`).
