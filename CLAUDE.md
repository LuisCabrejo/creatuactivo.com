...
- **entrar**, dicho de comprar el paquete o de iniciar (*«si usted entra con un paquete»*, *«quien entra con usted»*, *«entra al proyecto»*) → **comprar · iniciar · vincularse** (Director, 3 sep 2026). Es el verbo de la pirámide: a una cadena se *entra*; un inventario se *compra*. *«Le entra»* dicho del dinero sí vale. ⏳ Barrido pendiente: `EAM_01` 🔒 (*quien entra con usted*, doble fuente), `arsenal_avanzado` (*si entra en el nivel inicial*), `NIVELES_01` 🔒 (*entra a cobrar*)
