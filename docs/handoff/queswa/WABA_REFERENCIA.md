...
**Plantillas de la cuenta** — **8, todas `APPROVED`** (inventario verificado el 22 ago 2026 con `node scripts/auditar-plantillas-whatsapp.mjs --detalle`, que lee `category` y `previous_category` de `/{WABA_ID}/message_templates`):
...
| APPROVED | MARKETING (sometidas como UTILITY, **movidas por Meta**) | `acceso_centro_mando` · `enlace_canal_listo` · `enlace_canal_listo_v2` · `acceso_creatuactivo` |
