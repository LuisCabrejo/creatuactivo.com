-- SCRIPT 4/4: Insertar NUEVO documento arsenal_productos_beneficios
-- Archivo fuente: arsenal_productos_beneficios.txt
-- Fecha: 12 Noviembre 2025
-- Propósito: Respuestas especializadas sobre productos y beneficios Gano Excel con respaldo científico

-- VERSIÓN FIXED: Sin ON CONFLICT - Compatible con Supabase schema

-- Primero, eliminar documento si existe (para poder hacer INSERT limpio)
DELETE FROM nexus_documents WHERE category = 'arsenal_productos';
...
VALUES (
  gen_random_uuid(),
  'Arsenal Conversacional: Productos y Beneficios Gano Excel',
  'arsenal_productos',
  $$# Arsenal Conversacional: Productos y Beneficios Gano Excel v1.0

**Propósito:** Respuestas especializadas sobre productos Gano Excel y Ganoderma Lucidum, con respaldo científico y enfoque en beneficios concretos.

**Integración:** Este arsenal complementa el arsenal_conversacional_inicial y el catálogo_productos
---

## 🌿 **PREGUNTAS SOBRE PRODUCTOS (2 respuestas principales)**
...
**Categorías de productos y sus beneficios:**
...
4. **Biodisponibilidad garantizada**: Extracto 100% hidrosoluble vs. polvo de hongo convencional

**Pregunta de seguimiento:** ¿Qué categoría de productos resuena más contigo para tu consumo personal: bebidas diarias, suplementación intensiva, o experiencia premium?

---

### **PROD_02: "¿Por qué Ganoderma lucidum es tan especial?"**

Ganoderma lucidum (Reishi) es conocido en Asia como "el hongo de la inmortalidad", usado por más de 2,000 años en medicina tradicional china. Pero lo que realmente importa es **lo que dice la ciencia moderna**.
...
**Pregunta de seguimiento:** ¿Te interesa conocer más sobre alguna categoría específica de beneficios: inmunológico, mental, físico o metabólico?

---

## 🔬 **PREGUNTAS TÉCNICAS SOBRE GANODERMA (4 respuestas complementarias)**
...
**Cómo verificar:**
Puedes buscar en PubMed.gov usando términos: "Ganoderma lucidum", "Reishi mushroom", "Ganoderic acid"
...
## 📦 **CATEGORIZACIÓN POR NECESIDAD DEL USUARIO**

**Para el Constructor Empresario:**
- LUVOCO (impresiona clientes en casa)
...
**Documento:** Arsenal Productos y Beneficios v1.0
**Fecha:** Noviembre 12, 2025
**Fuentes:** PubMed 2024, Frontiers in Microbiology 2024, Nature Scientific Reports, PMC
**Propósito:** Responder preguntas sobre productos con respaldo científico verificable
**Integración:** Complementa arsenal_inicial (WHY/HOW) con WHAT (productos concretos)
$$,
  jsonb_build_object(
    'version', '1.0',
    'tipo', 'arsenal_productos',
    'respuestas_totales', 10,
    'respuestas_principales', 2,
    'respuestas_tecnicas', 4,
    'respuestas_categorización', 4,
    'enfoque', 'productos_beneficios_ciencia',
    'fuentes_cientificas', jsonb_build_array('PubMed', 'PMC', 'Nature', 'Frontiers in Microbiology'),
    'estudios_referenciados', '2000+',
    'fecha_investigacion', '2024',
    'disclaimer', 'alimentos_funcionales_no_medicamentos'
  ),
  NOW(),
  NOW()
);

-- Verificación: Confirmar que el documento se insertó correctamente
SELECT
  id,
  title,
  category,
  ...
  metadata->>'respuestas_totales' as respuestas_totales,
  metadata->>'fuentes_cientificas' as fuentes,
  created_at,
  updated_at
FROM nexus_documents
WHERE category = 'arsenal_productos';
