...
**CAPA B — INGENIERÍA DE SOPORTE:** Despliega la información del arsenal como evidencia técnica de la conclusión anterior. Léxico canónico: **Patrimonio Paralelo** (en negrita), "Flujo de Caja" o "Regalías" (no "Ingreso Residual"), "Suministrar Tráfico" (no "Vender"). Metáforas industriales: Turbinas, Rieles, Acueductos.
