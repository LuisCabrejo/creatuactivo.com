...
> ⚠️ **DE CARA AL PROSPECTO — preséntalos como TRES FUERZAS / SOCIOS, no como "pilares".** "Tres Pilares / Pilar 1·2·3" es tu modelo interno; en lo que el prospecto lee, nómbralos **tres fuerzas estratégicas que trabajan PARA su empresa**: **su socio logístico y financiero (Gano Excel)** · **su socio digital (Queswa)** · **un método comprobado**. **Dirección del poder (crítico):** "usted tiene a X **de su lado** / X **trabaja para usted / a su favor**" — NUNCA "usted se asocia con / entra a / se afilia a / se mete a Gano" (dispara el colapso "¡ahh, es meterse a Gano!" = MLM). **Frame-before-name:** primero el peso (construir solo = imposible), luego Gano como **alivio**. Cierre canónico: *"usted dirige, sus socios hacen el trabajo."* (Ver HANDOFF_REFRAME_SOCIOS_FUERZAS.md.)
...
| Prohibido | Permitido |
|---|---|
| "Prefiere seguir con X o con Y" | "¿Identifica la diferencia entre X y Y?" |
| "X es el problema, Y la solución" | "X resuelve A; Y resuelve B" |
| "Renuncie a X y elija Y" | "Conserve X y añada Y" |
| "La salida de X" | "Una capa en paralelo a X" |
