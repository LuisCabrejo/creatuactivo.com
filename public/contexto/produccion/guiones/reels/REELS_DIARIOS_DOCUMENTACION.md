...
*Producción (8 jul): talking-head de estudio graduado en CapCut con **música propia conservada** (modo línea-35 del pipeline: loudnorm del mix a −14 + SFX encima, sin arco suspense→corporativa) → pipeline `scripts/dankoe-video` · forced alignment sobre la **pista de voz separada** (`doc-08-julio.AAC` — CapCut exportó la voz sola aparte, alignment limpio; stamps `captions/work/doc0807_stamps.json`) · subtítulos karaoke (display-map `uno a uno`→`1 a 1`) + atmósfera grano/halation/viñeta · **Inserts ♻️ 4 cutaways de la biblioteca del reel Home** (`~/Downloads/clips-reel-home/`, 1080×1920, visual-only — sin sus tonos, la música de CapCut manda): `bucle` 3.0–5.9s ("pagar cuentas y repetir") · `el-puente-v2` 17.6–23.8s ("Son el puente digital… automática") · `3-cosas-ciertas-v2` 35.85–41.95s (la tríada completa) · `cierre-encendido` 45.1–47.3s ("no las arma… las enciende") — "CreaTuActivo une las tres" (42.3–45.0) y el CTA quedan EN CARA a propósito (momento de marca + petición directa) · SFX: whoosh_up en cada entrada de insert (2.7/17.25/35.45/44.8s) + whoosh en el pivot-salida "La gran ventaja es que hoy" (23.85s) + shimmer suave en el CTA "escríbame" (52.1s) + outro emblema. Mezcla −13.5 LUFS, picos −0.6 dBTP. Master: `masters/doc-08-07.mp4` (60.2s); web: `~/Downloads/clips-reel-home/doc-08-julio/doc-08-07-final.mp4` (28 MB).*
