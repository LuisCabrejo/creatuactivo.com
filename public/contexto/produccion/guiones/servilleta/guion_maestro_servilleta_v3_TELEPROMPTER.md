...
QUÉ CAMBIÓ EN v6.7 — Slides 3 y 4
Slide 4: sale el villano retirado de la OPCIÓN 1 («sus mejores años y su salud») y el rótulo «LA INACCIÓN», que calificaba a quien la eligiera; ahora es «DEJAR TODO COMO ESTÁ», que respeta la decisión y cierra con callback al villano del Slide 1. «Empresa digital» baja de 4 usos a 1: el último de todo el deck, que es donde el bautizo corresponde. Slide 3: fuera las viñetas-folleto y «hidrosoluble» → «se disuelve por completo en el agua… no se queda nada en el fondo de la taza».

QUÉ CAMBIÓ EN v6.6 — Slide 1
El villano pasa a la plata que llega ya repartida («al día siguiente de que le entra la plata, ese dinero ya tiene dueño»), y «le pasa igual al que gana dos millones y al que gana veinte» cierra el «ese no es mi caso» del que gana bien. Salen «sus mejores años y su salud» y «la consecuencia matemática». Seis conectores nuevos para el atril. La tercera pieza ya no es «usted» — son LOS PASOS EXACTOS; el dinero gana beat propio.

HISTORIAL Y FUNDAMENTO
Este archivo es el instrumento de lectura: solo lo que se dice en voz alta. El porqué de cada decisión y el historial completo (v5.1 → v6.8) viven en guion_maestro_servilleta_v3.md. Si los dos difieren, manda el maestro.
...
Usted trabaja el mes entero.

Pero al día siguiente de que le entra la plata,

ese dinero ya tiene dueño:

el banco, las cuotas, los recibos.

Es un ciclo de trabajar, pagar cuentas y repetir.
...
súmele algo todavía más incómodo.

Usted sostiene a los suyos

con lo que produce hoy,

y en el fondo sabe que eso se apoya

en variables que no controla:
...
Nosotros vemos una oportunidad enorme para cambiar eso.
...
que a casi nadie le gusta:

explicarle a cada persona,

responder a toda hora,

estar pendiente de cada uno.

No era falta de ganas.

Era que nadie tiene la vida

para dedicarse a eso todo el día.
...
ahí donde las personas ya viven

y se comunican todos los días.



Y lo tercero: los pasos exactos.

Usted no tiene que inventar nada

ni saber de tecnología:

el camino ya está trazado, paso por paso.
...
La más simple de todas: compartir.
...
Ahora la pregunta correcta:

¿qué hace usted, exactamente, en el día a día?
...
Un enlace, desde su celular,

con las personas que decida.

Eso es todo.

A partir de ahí, la conversación no la carga usted:

la atiende Queswa, por WhatsApp, las 24 horas.
...
usted lo recibe de persona a persona.

Ese es el único momento donde hace falta un ser humano —

y es el más valioso de todos.

Porque la tecnología explica, resuelve y madura la decisión…

pero la confianza de un apretón de manos,

la calidez de que alguien lo esté esperando del otro lado,

eso no lo da ninguna máquina.



[ EN VIVO — el Arquitecto se presenta aquí:
  "y en su caso, esa persona soy yo" ]

[ EN VIDEO GRABADO — lo dice el CEO:
  "Y en su caso, esa persona ya la conoce:
   es quien le compartió este video.
   Y detrás de ella hay un equipo completo." ]
...
la misma herramienta lista,

la misma fábrica detrás,
...
usted llama a un amigo en Estados Unidos,

le hace la propuesta, él inicia…

y ya tiene un punto de distribución en Estados Unidos.

Al alcance de una llamada.
...
Y aquí está lo que de verdad lo separa del resto.

No es cualquier Ganoderma:

es un híbrido único en el mundo,

hecho con las seis variedades de mayor valor.

Y Gano Excel lo entrega en un extracto

que se disuelve por completo en el agua,

de modo que el cuerpo lo aprovecha todo —
...
un producto que las personas vuelven a pedir,

una tecnología que atiende por usted,

y un porcentaje que cae los viernes.



De aquí, lo que he visto

es que las personas hacen una de tres cosas.
...
y hoy para muchos es la que tiene sentido.
...
Todavía no quiere pensar en el negocio,

pero sí quiere el producto en su casa.

Se registra como Cliente Preferencial

y compra al mismo precio que un distribuidor:

un 25% menos que el precio sugerido.

Se lo toma, ve cómo le va,

y si más adelante le nace tener su propio negocio,
...
[ PAUSA · 2 SEGUNDOS · CAÍDA DE ENTONACIÓN · MIRADA DIRECTA ]



Al principio le dije

que usted trabaja el mes entero,
...
Esto no cambia eso de la noche a la mañana.

Lo que hace es empezar a construirle

una parte que sí sea suya:

un viernes en que entra algo
