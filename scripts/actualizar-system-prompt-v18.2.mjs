 ...
 * Actualizar System Prompt a v18.2 (Accesibilidad Radical)
...
async function actualizarSystemPrompt() {
  ...
  const { data, error } = await supabase
    ...
    .update({
      ...
      version: 'v18.2_accesibilidad_radical',
  ...
  console.log('');
  console.log('✅ v18.2 activo. El caché expira en 5 min (o reinicia el servidor).');
}
