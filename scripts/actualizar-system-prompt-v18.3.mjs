 ...
 * Actualizar System Prompt a v18.3 (Regla Steve Jobs - Sin Nodos/Hardware)
...
async function actualizarSystemPrompt() {
  ...
  const { data, error } = await supabase
    ...
    .update({
      ...
      version: 'v18.3_regla_steve_jobs',
  ...
  console.log('');
  console.log('✅ v18.3 activo. Vocabulario limpio: sin Nodos, sin Hardware/Software.');
