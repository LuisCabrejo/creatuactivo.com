 ...
 * Actualizar System Prompt a v19.2 (Sin Jerga de Marketing)
...
async function actualizarSystemPrompt() {
  ...
  const { data, error } = await supabase
    ...
    .update({
      ...
      version: 'v19.2_sin_jerga_marketing',
  ...
  console.log('');
  console.log('✅ v19.2 activo. Cero jerga de marketing:');
  console.log('   embudo → sistema de filtrado / plataforma de evaluación');
  console.log('   pipeline → sistema de atracción');
  console.log('   $200K creaTuActivo ≠ logística Gano Excel (capitales separados correctamente)');
