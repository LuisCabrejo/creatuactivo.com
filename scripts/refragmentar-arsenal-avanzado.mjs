 ...
 *
 * Re-fragmenta arsenal_avanzado en una sola pasada (purga + fragmentación).
 * Adaptado de refragmentar-arsenal-inicial.mjs.
 *
 * Uso: node scripts/refragmentar-arsenal-avanzado.mjs
 */
...
const ARSENAL = 'arsenal_avanzado';
      ...
      const { error } = await supabase
        ...
        .insert({
          ...
          metadata: {
            ...
            source_version: 'v11.1_alineacion_sp_v26_4'
          }
        });
...
async function main() {
  console.log(`\n${'='.repeat(60)}`);
  console.log(`🔧 RE-FRAGMENTACIÓN ARSENAL_AVANZADO — v11.1`);
  console.log('='.repeat(60));
