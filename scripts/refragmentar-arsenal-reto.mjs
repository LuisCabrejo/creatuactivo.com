 ...
 *
 * Re-fragmenta arsenal_reto en una sola pasada (purga + fragmentación).
 * Adaptado de refragmentar-arsenal-inicial.mjs.
 *
 * Uso: node scripts/refragmentar-arsenal-reto.mjs
 */
      ...
      const { error } = await supabase
        ...
        .insert({
          ...
          metadata: {
            ...
            source_version: 'v4.3_alineacion_sp_v26_4'
          }
        });
...
async function main() {
  console.log(`\n${'='.repeat(60)}`);
  console.log(`🔧 RE-FRAGMENTACIÓN ARSENAL_RETO — v4.3`);
  console.log('='.repeat(60));
