...
function clasificarDocumentoHibrido(userMessage: string): string | null {
  ...
  const patrones_12_niveles = [
    ...
    // «el plan de 12 días» (prueba del Director, 1 sep 2026): quien oyó el
...
function interpretQueryHibrido(userMessage: string): string {
  ...
  const mapeos_semanticos: Record<string, string> = {
    ...
    'arquitectura': 'El Método Comprobado Expansión Activación Multiplicación Queswa CreaTuActivo aplicación arquitectura sistema',
    'funcionamiento': 'cómo funciona El Método Comprobado Expansión Activación Multiplicación proceso sistema método probado',
    ...
    'impacto exponencial': 'cómo funciona El Método Comprobado Expansión Activación Multiplicación proceso sistema método',
...
function extraerKeywordsHibrido(message: string): string {
  ...
  const keywords_ecosistema = [
    'CreaTuActivo', 'ecosistema', 'Método Comprobado', 'Expansión', 'Activación', 'Multiplicación',
...
o esa misma línea — no sobre otro.`;
      ...
      if (pageContext?.startsWith('whatsapp_salud_')) {
        ...
        const acuse = declara
          ...
          : fam === 'evidencia'
          ? 'Pidió la ciencia: trátela como alguien que quiere la respuesta exacta. Abra EXACTAMENTE con esta frase y nada más en el primer párrafo: «El Ganoderma es uno de los hongos más estudiados del mundo, y esa literatura es pública.» ⛔ No le agregue nada a esa frase: ni «quien quiera puede ir a…», ni el nombre de PubMed ni de ningún repositorio, revista o estudio — mandarla a buscar la ciencia dentro de esta conversación es la forma exacta que sanciona la norma, y el filtro de salida descarta el turno entero si aparece. Nunca cite, resuma ni enlace un estudio. ⛔ Y nada de «su médico», «su tratamiento» ni «su caso»: no dijo que fuera para ella; si hace falta, «el médico tratante» o «la conversación que quiera tener».'
...
• ESP-2 Empresarial: Gen1=$337.500 | Gen2=$45.000 | Gen3=$45.000 | Gen4=$45.000 | Gen5=$90.000 COP
• ESP-1 Inicial: Gen1=$112.500 | Gen2=$22.500 | Gen3=$22.500 | Gen4=$22.500 | Gen5=$45.000 COP`
...
${filasGen5}`;
    ...
    const getTablasComisiones = (): string => {
      ...
      const filaGen5 = monedaCO
        ? `| Gen 1 (directo) | $675.000 | $337.500 | $112.500 |
| Gen 2 | $90.000 | $45.000 | $22.500 |
| Gen 3 | $90.000 | $45.000 | $22.500 |
| Gen 4 | $90.000 | $45.000 | $22.500 |
| Gen 5 | $180.000 | $90.000 | $45.000 |`
