...
const VIDEO_1080P = 'https://tydh3stq7cgynabr.public.blob.vercel-storage.com/videos/mapa-dia4-1080p.mp4';
const VIDEO_720P  = 'https://tydh3stq7cgynabr.public.blob.vercel-storage.com/videos/mapa-dia4-720p.mp4';
const POSTER      = 'https://tydh3stq7cgynabr.public.blob.vercel-storage.com/videos/mapa-dia4-poster.jpg';
...
function trackEvent(event: string) {
  try {
    ...
    fetch('/api/nexus', {
      ...
      body: JSON.stringify({ event, page: 'auditoria-dia-4', fingerprint: fp }),
      keepalive: true,
    }).catch(() => {});
  } catch {}
}
