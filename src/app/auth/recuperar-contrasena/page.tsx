...
// --- Componente Principal de la Página de Recuperar Contraseña ---
                    ...
                    >
                        {isSubmitted ? (
                             <div className="text-center">
                                ...
                                <h1 className="text-2xl font-bold text-white">Enlace Enviado</h1>
                                <p className="text-slate-300 mt-2 mb-6">Hemos enviado un enlace para restablecer tu contraseña a **{email}**. Por favor, revisa tu bandeja de entrada (y la de spam).</p>
                            ...
                            <>
                                <div className="text-center mb-8">
                                    ...
                                    <p className="text-slate-400 mt-2">Ingresa tu email de constructor y te enviaremos un enlace para restablecer tu contraseña.</p>
                                </div>
                                <form onSubmit={handlePasswordReset} className="space-y-6">
                                    ...
                                    <div>
                                        <button type="submit" className="w-full creatuactivo-cta-ecosystem text-base flex items-center justify-center">
                                            Enviar Enlace de Recuperación <ArrowRight size={20} className="ml-2" />
                                        </button>
                                    </div>
