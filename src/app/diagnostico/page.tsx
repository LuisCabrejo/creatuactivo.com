...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      { value: 10, label: 'Frustrado', sublabel: 'La plata entra y se va; soy solo el puente por donde pasa' },
      { value: 50, label: 'Conforme', sublabel: 'Algo guardo, pero no lo suficiente para cambiar nada' },
      { value: 100, label: 'Tranquilo', sublabel: 'Lo que gané se quedó y sigue ahí' },
    ],
  },
  {
    id: 'apalancamiento',
    ...
    options: [
      { value: 10, label: 'Sí, así es', sublabel: 'Más plata significa más horas mías' },
      { value: 50, label: 'Más o menos', sublabel: 'Tengo ayuda, pero todo sigue pasando por mí' },
      { value: 100, label: 'No', sublabel: 'Lo que construí puede crecer sin que yo meta más horas' },
    ],
  },
  {
    id: 'pazMental',
    ...
    options: [
      { value: 10, label: 'Poca', sublabel: 'Vivo con el estrés del dinero casi siempre' },
      { value: 40, label: 'Más o menos', sublabel: 'Hay meses buenos y meses de angustia' },
      { value: 70, label: 'Buena', sublabel: 'Me siento bastante seguro' },
