          ...
          <section className="max-w-6xl mx-auto mb-20 lg:mb-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <ComponentCard
                ...
                title="1. Gano Excel"
                description="Productos únicos con patente mundial. Nadie más puede venderlos."
              />
              <ComponentCard
          ...
          <section className="max-w-4xl mx-auto mb-20 lg:mb-32">
            ...
            <div className="space-y-4">
              <FAQItem
                ...
                answer="Productos de salud de Gano Excel: café, té y suplementos con Ganoderma (un hongo medicinal con patente mundial). Son productos que la gente compra cada mes."
              />
              <FAQItem
