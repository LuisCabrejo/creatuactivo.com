      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '48px 20px 80px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          ...
          <p style={{ color: C.mutedLight, fontSize: '15px', margin: 0, fontFamily: "'Rajdhani', sans-serif", letterSpacing: '0.04em' }}>
            Día 5 — Las tres formas de empezar su empresa digital
          </p>
        </div>
        ...
        <div style={{ borderLeft: `2px solid ${C.gold}`, padding: '18px 24px', margin: '28px 0', background: 'rgba(197, 160, 89,0.04)' }}>
          <p style={{ color: '#E5E5E5', fontSize: '15px', lineHeight: 1.75, margin: 0 }}>
            Los cinco días están completos. Con los números sobre la mesa, decida <strong>con cuál de las tres formas quiere empezar</strong> y dé el paso final para activar su empresa digital.
          </p>
        </div>
