 ...
 * Página "Manifiesto / Documento Fundacional" v5.0
 *
 * Estructura: Historia empática (Epiphany Bridge) → Manifiesto de los Fundadores
 * (8 secciones, fuente: MANIFIESTO_FUNDADORES.md) → CTA.
 * Objetivo: posicionar a Luis como Arquitecto de Patrimonio y alinear a los 15.
 *
 * THE ARCHITECT'S SUITE - Bimetallic System v3.0
 * Gold (#C5A059): CTAs, highlights, key titles · Titanium (#94A3B8): estructura
 */
        ...
        <div className="relative z-10">
          ...
          <article className="py-0 px-6">
            ...
            >
              ...
              {/* El Pivote (termina aquí — entrega al manifiesto) */}
              <div>
                <p className="text-sm uppercase tracking-[0.15em] text-[#C5A059] mb-6">
                  El Pivote
                </p>
