 ...
 * Nueva Página de Inicio - Quiet Luxury Branding
    ...
    >
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          {/* Logo */}
          <Link href="/prueba" className="flex items-center gap-3">
            <div
          ...
          <Link
            href="#calculadora"
            className="hidden sm:inline-flex items-center gap-2 px-5 py-2.5 rounded-lg font-medium transition-all duration-300 hover:opacity-90"
            style={{
