...
// --- Estilos CSS Globales (Bimetallic System v3.0) ---
const GlobalStyles = () => (
  <style jsx global>{`
    :root {
      --carbon-deep: #0F1115;
    ...
    /* TIPOGRAFÍA TITULARES (Estilo Apple: Blanco a Titanio) */
    ...
    /* EFECTO VIDRIO (Glassmorphism - Bimetallic) */
    .glass-card {
    ...
    /* TARJETAS DE DÍA (Reto - Bimetallic) */
    .day-card {
...
const ProjectionRow = ({ level, people, income }: any) => (
  <tr className={`projection-row border-b border-white/5 ${level >= 10 ? 'milestone-row' : ''}`}>
    <td className="py-3 px-4 text-[#A3A3A3] font-mono text-sm">Nivel {level}</td>
    <td className="py-3 px-4 text-white font-mono text-sm text-center">{people.toLocaleString()}</td>
    <td className="py-3 px-4 text-right font-mono text-sm font-bold text-[#10B981]">
      ...
      <div className="glass-card rounded-xl overflow-hidden mb-3">
        ...
        {isOpen && (
          <div className="px-5 pb-5 pt-0">
            <p className="text-[#A3A3A3] text-sm leading-relaxed whitespace-pre-line border-t border-white/5 pt-4">{answer}</p>
          </div>
        )}
      </div>
    );
      ...
      <div className="bg-[#0F1115] text-[#E5E5E5] min-h-screen font-sans selection:bg-[#C5A059]/30">
        ...
        <section ref={challengeSectionRef} className="py-20 border-t border-white/5 bg-[#15171C]/80">
            <div className="container mx-auto px-4 max-w-6xl">
                <div className="text-center mb-10">
                    ...
                    <p className="text-[#A3A3A3] text-sm">El poder del interés compuesto aplicado a las relaciones humanas.</p>
                    <p className="text-xs text-[#64748B] mt-2">Clic en cualquier ciclo para pausar o saltar</p>
                </div>
            ...
            <div className="container mx-auto px-4 max-w-6xl">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    ...
                    <div className="glass-card p-10 rounded-3xl relative overflow-hidden group">
                        ...
                        <p className="text-[#A3A3A3] text-sm leading-relaxed">Gano Excel pone la infraestructura de mil millones de dólares, el producto, la legalidad y los pagos.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section className="py-24 bg-[#15171C] border-y border-white/5">
            <div className="container mx-auto px-4 max-w-4xl">
                        ...
                        <table className="w-full text-left">
                            <thead className="bg-[#0F1115]/80 border-b border-white/10">
                                <tr>
                                    ...
                                    <th className="py-4 px-4 text-xs font-bold text-[#64748B] uppercase tracking-wider text-right">Renta Acumulada</th>
                                </tr>
                            </thead>
                            <tbody>
                ...
                <p className="text-xs text-[#64748B] text-center mt-6 max-w-2xl mx-auto">
...
Todos tienen acceso al sistema y la tecnología. La diferencia es la velocidad con la que puedes escalar."
                ...
                <div className="glass-card p-8 md:p-12 rounded-3xl border border-[rgba(197,160,89,0.2)] shadow-2xl">
                    ...
                    {submitStatus === 'success' ? (
                        <div className="text-center py-12 animate-in zoom-in duration-300">
                            ...
                            <a href="https://wa.me/573102066593" className="inline-flex items-center gap-2 text-[#10B981] font-bold hover:underline">
                        ...
                        <form onSubmit={async (e) => {
                            ...
                            <div>
                                <label className="text-xs font-bold text-[#64748B] uppercase ml-1 mb-1 block">Correo Electrónico</label>
                                <input
                                    type="email" required
                            ...
                            <div>
                                <label className="text-xs font-bold text-[#64748B] uppercase ml-1 mb-1 block">WhatsApp</label>
                                <input
                                    type="tel" required
                            ...
                            <div>
                                <label className="text-xs font-bold text-[#64748B] uppercase ml-1 mb-1 block">Nivel de Interés</label>
                                <select
        ...
        {/* --- FOOTER --- */}
        <footer className="py-12 text-center text-[#64748B] text-sm border-t border-white/5">
            <p>&copy; 2026 CreaTuActivo.com</p>
        </footer>
