...
export const REEL_COPY: Record<ReelNicho, { titulo: string; cuerpo: string; audiencia: string }> = {
  corporativo: {
    ...
    cuerpo:
      'El mercado rara vez paga afuera lo que usted vale adentro de una empresa que no es suya. La respuesta no es trabajar más duro, ni renunciar a lo que ya construyó: es tener algo propio, en paralelo. Una empresa digital que produce por usted —ya funcionando en 15 países de América— sostenida por 3 pilares que cargan el trabajo pesado: Gano Excel pone la logística; Queswa, su inteligencia artificial, atiende a los interesados las 24 horas; y un método probado le marca cada paso.',
  },
  empleados: {
    ...
    cuerpo:
      'Por más duro que trabaje, entrega sus mejores años y su salud, y solo suma antigüedad… nada que de verdad sea suyo. Eso no es falta de esfuerzo: así está calibrado el sistema. La respuesta no es trabajar más: es tener algo propio, en paralelo. Una empresa digital que crece por diseño, no por su desgaste —sostenida por Gano Excel, que pone la logística; Queswa, su inteligencia artificial, que atiende a los interesados 24/7; y un método probado que le marca cada paso.',
  },
  empresarios: {
    ...
    cuerpo:
      'Un negocio que depende de su presencia no es un patrimonio; es un puesto que usted mismo creó: no se hereda tranquilo, no se vende por lo que vale y no produce sin su supervisión. La respuesta es tener algo que sí funcione sin usted: una empresa digital, sostenida por 3 pilares que cargan el trabajo pesado —Gano Excel pone la logística; Queswa atiende a los interesados 24/7; y un método probado le marca cada paso.',
  },
  diaspora: {
    ...
    cuerpo:
      'Usted ya construyó una nueva vida; pero si se detiene 30 días, todo se tambalea. La respuesta no es sumar más horas a su semana: es tener algo propio que funcione sin usted. Una empresa digital, ya funcionando en 15 países de América, sostenida por 3 pilares que cargan el trabajo pesado —Gano Excel pone la logística; Queswa atiende a los interesados 24/7; y un método probado le marca cada paso.',
  },
  informales: {
    ...
    cuerpo:
      'Vivir en el ciclo de trabajar, pagar cuentas y repetir —donde la plata se va tan rápido como llega— no es falla suya: así está calibrado el sistema. Hay una ruta para construir un ingreso que se acumule y siga entrando aunque usted no esté de pie todo el día: tener algo propio, una empresa digital que produce por usted —sostenida por Gano Excel, que pone la logística; Queswa, que atiende a los interesados 24/7; y un método probado que le marca cada paso.',
  },
  networkers: {
